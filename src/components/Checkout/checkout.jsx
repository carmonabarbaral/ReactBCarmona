     ...
     <div className="container contForm">
          <form onSubmit={consultarForm} ref={datosForm}>
                ...
                <div className="mb-3">
                   ...
                   <input type="text" required className="form-control" name="email" value={input1Value} onChange={handleInput1Change}/>
                </div> 
                <div className="mb-3">
                    <label htmlFor="nombre" className="form-label">Confirme email</label>
                    <input type="text" required className="form-control" name="email" value={input2Value} onChange={handleInput2Change}/>
                </div> 
                <div className="mb-3">
